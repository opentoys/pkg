...
func funcs_typeOf(v interface{}) reflect.Type {
	return reflect.TypeOf(v)
}

func funcs_typeOfPointer(v interface{}) reflect.Type {
...
// Get the copy function for the pair of types, if it is not found then nil is returned.
func FuncsGet(dst, src reflect.Type) func(dst, src unsafe.Pointer) {
	return funcs_funcs.Get(dst, src)
}

// Set the copy function for the pair of types.
func FuncsSet(dst, src reflect.Type, f func(dst, src unsafe.Pointer)) {
	funcs_funcs.Set(dst, src, f)
}

var funcs_funcs = &CopyFuncs{
	funcs: map[funcKey]func(dst, src unsafe.Pointer){},
	sizes: []func(dst, src unsafe.Pointer){},
}
